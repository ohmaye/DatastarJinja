"""
Navigation data configuration for the application navigation.
...
NAV_DATA = [
    ...
    },
    {
        ...
        "menu_items": [
            ...
            {"icon": "cog", "text": "Config Survey", "url": "/survey/surveys"},
        ],
    },
    {
        "title": "SPIN Cycle",
        ...
        "menu_items": [
            ...
            {"icon": "user-round-search", "text": "Selections", "url": "/spin/selections"},
    ...
    },
    {
        ...
        "menu_items": [{"icon": "help-circle", "text": "Ask Kozue", "url": "/"}],
    },
]
